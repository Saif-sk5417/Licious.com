...
import { getCart, getSeaFoodData } from "./Redux/action";
import { SingleCard } from "./SingleCard";
import styles from "./SingleCard.module.css";
import SkeletonCard from "./Skelton";
const SeaFood = () => {
  const dispatch = useDispatch();
  const { isLoading, SeaFoodData } = useSelector((store) => store.reducer);
  ...
  return (
    <div style={{ marginTop: "150px" }}>
      ...
      {!isLoading && SeaFoodData.length === 0 && (
        <div>
          <ChakraProvider>
            <Box mb="100px">
