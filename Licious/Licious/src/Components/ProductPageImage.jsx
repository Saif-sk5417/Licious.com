    ...
    <div>
      <div className={styles.ProductPageImage_Main}>
        <div className={styles.ProductPageImage_Box1}>
          <hr />
          <p>
            The <span>Licious</span> Way
          </p>
        </div>
        <div className={styles.ProductPageImage_Box2}>
          {Data.map((el) => {
            return (
              <div key={el.img} className={styles.ProductPageImage_Box3}>
                <div className={styles.ProductPageImage_img}>
                  <img src={el.img} alt={el.text} />
                </div>
                <div className={styles.ProductPageImage_text}>
                  <p>{el.text}</p>
                </div>
              </div>
            );
